...
　google suggestワークフローでxmlを利用しているようでしたので、解析してみました。
　解析といっても、なんとなくphpの構文や動きを理解する程度です。
  https://github.com/KitanoTamotsu/tips3/
　そうしたらAlfred出力用のxmlがあることがわかったので試してみました。
　xmlで扱われている部分もあるようですが、多分過去バージョンを保証する意味で残しているだけなのか、
